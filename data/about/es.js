...
export const TIMELINE = [
  ...
  { year: '2024', title: 'Certificado FSC',
    text: 'Lograda la certificación FSC de cadena de custodia. Fábrica ampliada a 20.000 m² con nueva área de acabado y QC.' },
...
export const LOCATIONS = [
  ...
  },
  {
    ...
    details: [
      '20.000 m² con líneas CNC, láser, acabado y ensamblaje',
...
export const VALUES = [
  { num: '01', title: 'Fábrica Real, No un Trader',
    text: 'Nuestra fábrica de 20.000 m² en Cao County es propiedad y operación directa de Chic Homeware — sin intermediarios, sin cadena de márgenes y sin teléfono escacharrado entre tú y el taller.' },
...
export const CERTS = [
  ...
  { slug: 'eu-reach', name: 'EU REACH',  status: 'Certificado',          pending: false },
  { slug: 'carb',     name: 'CARB P2',   status: 'Certificado',          pending: false },
  { slug: 'iso-9001', name: 'ISO 9001',  status: 'Certificado',          pending: false },
];
...
export const COPY = {
  meta: {
    ...
    description:
      'Xiamen Chic Homeware Co.,Ltd. — fabricante de cajas de madera personalizadas con cinco años de historia, oficina de ventas en Xiamen y fábrica de 20.000 m² en Cao County, Shandong. Servimos a marcas de Amazon e importadores en Europa, EE. UU., Japón y Corea.',
    ogDescription:
      'Fabricante de cajas de madera personalizadas con fábrica de 20.000 m² en Cao County, Shandong. Servicio a marcas de Amazon e importadores en todo el mundo.',
  },
  hero: {
  ...
  story: {
    ...
    p1html:
      '<strong>Xiamen Chic Homeware Co.,Ltd. fue fundada en 2021</strong> por un equipo de veteranos del sector chino de productos de madera. Nuestro fundador, <strong>Chuan Pu</strong>, pasó más de dos décadas dentro del comercio de la madera — recorriendo aserraderos en Cao County, ejecutando programas CNC en Heze y gestionando pedidos de exportación desde Xiamen — antes de fundar Chic para hacer las cosas de otra manera.',
    p2html:
  ...
  certs: {
    ...
    paragraph:
      'Nuestra madera procede de canales forestales certificados FSC y operamos un programa de cadena de custodia para mantener trazabilidad limpia desde el tronco hasta el cartón. También cumplimos con CARB P2 (emisiones de formaldehído de EE. UU.) y EU REACH, además de contar con un sistema de gestión de calidad ISO 9001, para que cada envío esté listo para los requisitos de importación en EE. UU., la UE y más allá.',
  },
  cta: {
