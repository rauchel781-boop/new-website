...
export const COPY = {
  ...
  story: {
    ...
    titleEm: '브랜드인들을 위해.',
    p1html:
      '<strong>Xiamen Chic Homeware Co.,Ltd.는 2021년에 창립되었습니다</strong>. 중국 목제품 산업 베테랑들의 팀이 설립한 회사입니다. 창립자 <strong>Chuan Pu</strong>는 차오현의 목재 야적장을 걸어 다니고, 헤쩌에서 CNC 프로그램을 운영하고, 샤먼에서 수출 주문을 관리하며 20년 이상 목재 무역에 몸담은 후 — 다른 방식으로 일하기 위해 Chic을 시작했습니다.',
    p2html:
