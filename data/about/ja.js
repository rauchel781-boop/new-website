...
export const COPY = {
  ...
  story: {
    ...
    titleEm: 'ブランドの人々のために。',
    p1html:
      '<strong>Xiamen Chic Homeware Co.,Ltd. は2021年に創業されました</strong>。中国の木製品業界のベテランチームによる設立です。創業者の<strong>Chuan Pu</strong>は20年以上にわたり木材業界に身を置き — 曹県の木材ヤードを歩き回り、菏沢でCNCプログラムを動かし、厦門から輸出オーダーを管理した後 — 異なるやり方をするためにChicを立ち上げました。',
    p2html:
